...
The true structure is three things at once, and each has laws that hold *exactly*, machine-checked in `test/test_core_laws.py` with `hypothesis`.
...
---
[← State & timeline](state.md) · [Home](index.md) · [Appraisal →](appraisal.md)
